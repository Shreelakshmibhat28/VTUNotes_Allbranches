...
// CompSci class
class EleCom extends StatefulWidget {
  const EleCom({Key? key, required this.branch}) : super(key: key);
  final String branch;
  @override
  State<EleCom> createState() => _EleComState();
}

class _EleComState extends State<EleCom> {
